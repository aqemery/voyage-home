...
func _on_area_2d_body_entered(body):
    ...
    match vip_type:
        VipType.ENGINEER:
            ...
            dialog = [
                "Thank you for recusing me! I ran into trouble looking for special ore for a project.",
        ...
        VipType.ASTRONOMER:
            ...
            dialog = [
                "Thank you for recusing me! This is embarrassing, but I got lost while looking for a sensor tower.",
        ...
        VipType.EXOBIOLOGIST:
            ...
            dialog = [
                "Thank you for recusing me! I was in the middle of a mission to find alien artifacts when I got lost.",
