...
func show_dialog():
    match Inventory.engineer:
        ...
        Inventory.VipState.FOUND:
            ...
            await DialogManager.show_dialog("I was trying to collect ore for a new shield I am designing.")
        ...
        Inventory.VipState.RETURNED:
            if Inventory.ore < 4:
                ...
                await DialogManager.show_dialog("Let's upgrade the shields on your ship.")
                Inventory.engineer = Inventory.VipState.UPGRADED
        Inventory.VipState.UPGRADED:
            await DialogManager.show_dialog("How are those upgraded shields treating you?")
